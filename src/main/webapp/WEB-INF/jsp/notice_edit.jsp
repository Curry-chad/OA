...
<div style="padding:10px 10px 10px 10px">
	<form id="noticeEditForm" class="orderForm" method="post">
	    ...
	    <table cellpadding="5">
	        ...
	        <tr>
	            ...
	            <td>
	                 ...
	                 <div id="noticeEditFileUploader">上传文件</div>
	                 <input type="hidden" id="noticeEditFile" name="noticeFile"/>
	            </td>
	        </tr>
	        <tr>
	            <td>通知文件备注:</td>
	...
	<div style="padding:5px">
	    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="submitNoticeEditForm()">提交</a>
	</div>
</div>
<script type="text/javascript">
	...
	$(function(){
		//实例化富文本编辑器
		orderEditEditor = TAOTAO.createEditor("#noticeEditForm [name=noticeNote]");
	});
	//同步kindeditor中的内容
	...
	function submitNoticeEditForm(){
		...
		$.post("notice/update_all",$("#noticeEditForm").serialize(), function(data){
			if(data.status == 200){
				$.messager.alert('提示','修改通知文件成功!','info',function(){
